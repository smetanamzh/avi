...
- [x] **Логи без rotation**  
  ...
  **Статус:** ✅ Сделано (2026-08-06) — добавлено логирование текстов, ответов LLM и таймингов
...
- [x] **AI decision logging**
  ...
  **Статус:** ✅ Сделано (2026-08-06) — добавлено логирование ответов LLM (YES/NO) + причина skip
...
5. **Запустить `--once` с новым логированием** → найти false-negative посты
